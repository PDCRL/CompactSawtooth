...
# source: sawtooth_cli/protobuf/block_info.proto
...
BlockInfoConfig = _reflection.GeneratedProtocolMessageType('BlockInfoConfig', (_message.Message,), dict(
  ...
  __module__ = 'sawtooth_cli.protobuf.block_info_pb2'
